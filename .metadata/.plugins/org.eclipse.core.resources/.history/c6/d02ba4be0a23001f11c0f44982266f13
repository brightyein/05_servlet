...
<a href="querystring?name=김예인&age=28&birthday=1996-02-26&gender=F&national=ko&hobbies=movie&hobbies=sleep">쿼리스트링을 이용한 값 전달</a>
...
<input type="checkbox" name ="hobbies" id="music2" value="music"><label for="music2">음악감상</label>
